...
public class ArtistFragment extends Fragment implements android.support.v4.app.LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        if (data.moveToFirst()) {
            ...
            do {
                ...
                mAlbumItem.setNoOfTrack(data.getString(data.getColumnIndex( MediaStore.Audio.ArtistColumns.NUMBER_OF_TRACKS)));
    ...
    public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.MyViewHolder> {
        ...
        private List<ArtistItem> mediaList;

        public class MyViewHolder extends RecyclerView.ViewHolder {
            public TextView tvAlbumTitle, tvNoOfSong;
            ...
            public MyViewHolder(View view) {
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ArtistItem album = mediaList.get(itemPosition);
                        Cursor c = getActivity().getContentResolver().query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, new String[]{MediaStore.Audio.Media.TITLE,
                                ...
                                MediaStore.Audio.Media.DATA,MediaStore.Audio.Media.ALBUM_ID,MediaStore.Audio.Media.COMPOSER},MediaStore.Audio.Media.ARTIST + " = ?",new String[]{String.valueOf(album.getArtistName())}, null);
        ...
        public ArtistAdapter(List<ArtistItem> moviesList) {
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ArtistItem audio = mediaList.get(position);
            holder.tvAlbumTitle.setText(audio.getArtistName());
            holder.tvNoOfSong.setText(String.valueOf(audio.getNoOfTrack()));
        }
